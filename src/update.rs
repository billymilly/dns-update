...
#[cfg(any(feature = "ring", feature = "aws-lc-rs"))]
use crate::providers::wedos::WedosProvider;
...
impl DnsUpdater {
    ...
    /// Create a new DNS updater using the Wedos API.
    pub fn new_wedos(config: crate::providers::wedos::WedosConfig) -> crate::Result<Self> {
        Ok(DnsUpdater::Wedos(WedosProvider::new(config)?))
    }
